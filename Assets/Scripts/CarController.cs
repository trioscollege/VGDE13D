...
public class CarController : MonoBehaviour 
{
	...
	private float CheckOnComing()
	{
		...
		Debug.DrawRay(carFrontRight, (transform.right*0.25f + transform.forward) * cornerDistance);
		
		//if we detect a car to the right turn left.
		if(Physics.Raycast(carFrontRight, (transform.right*0.25f + transform.forward), out hit, cornerDistance))
		{
		...
		Debug.DrawRay(carFrontLeft, (-transform.right*0.25f + transform.forward) * cornerDistance);
		
		//if we detect a car to the left turn right.
		if(Physics.Raycast(carFrontLeft, (-transform.right*0.25f + transform.forward), out hit, cornerDistance))
		{
