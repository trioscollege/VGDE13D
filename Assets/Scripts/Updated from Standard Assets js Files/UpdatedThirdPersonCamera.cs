...
public class UpdatedThirdPersonCamera : MonoBehaviour {
	...
	private UpdatedThirdPersonController controller;
	...
	void Awake (){
		...
		if (_target)
		{
			controller = _target.GetComponent<UpdatedThirdPersonController>();
		}
