...
public class UpdatedCharacterMotorMovement {
...
public class UpdatedCharacterMotor : MonoBehaviour {
...
public UpdatedCharacterMotorMovement movement = new UpdatedCharacterMotorMovement();
...
public class UpdatedCharacterMotorJumping {
...
UpdatedCharacterMotorJumping jumping = new UpdatedCharacterMotorJumping();

public class UpdatedCharacterMotorMovingPlatform {
	public bool enabled = true;
...
public UpdatedCharacterMotorMovingPlatform movingPlatform = new UpdatedCharacterMotorMovingPlatform();

public class UpdatedCharacterMotorSliding {
...
public UpdatedCharacterMotorSliding sliding = new UpdatedCharacterMotorSliding();
